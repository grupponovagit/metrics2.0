        ...
        <thead class="bg-base-200" style="background-color: #f3f4f6 !important;">
            <tr>
                ...
                <th class="col-costo font-bold text-sm uppercase tracking-wider text-center bg-blue-100 border-r-2 border-base-300"
                    rowspan="2" style="position: sticky !important; top: 0 !important; z-index: 10 !important; min-width: 100px;">
                    Costo</th>

                <th class="col-leads font-bold text-sm uppercase tracking-wider text-center bg-green-100 border-r-2 border-base-300"
                    rowspan="2" style="position: sticky !important; top: 0 !important; z-index: 10 !important; min-width: 80px;">
                    Lead</th>
            ...
            <tr style="position: sticky !important; top: 48px !important; z-index: 9 !important;">
                <th class="col-conversioni font-bold text-xs text-center bg-teal-50 border-r border-base-200" style="min-width: 80px;">Conv.</th>
                <th class="col-conversioni font-bold text-xs text-center bg-teal-50 border-r border-base-200" style="min-width: 80px;">OK Lead</th>
                <th class="col-conversioni font-bold text-xs text-center bg-teal-50 border-r-2 border-base-300" style="min-width: 80px;">KO Lead</th>
                
                <th class="col-economics font-bold text-xs text-center bg-amber-50 border-r border-base-200" style="min-width: 90px;">CPL</th>
                <th class="col-economics font-bold text-xs text-center bg-amber-50 border-r border-base-200" style="min-width: 90px;">CPA</th>
                <th class="col-economics font-bold text-xs text-center bg-amber-50 border-r-2 border-base-300" style="min-width: 90px;">CPC</th>
                
                <th class="col-performance font-bold text-xs text-center bg-purple-50 border-r border-base-200" style="min-width: 90px;">ROAS %</th>
                <th class="col-performance font-bold text-xs text-center bg-purple-50 border-r-2 border-base-300" style="min-width: 90px;">ROI %</th>
            </tr>
        </thead>
        <tbody>
            @php
