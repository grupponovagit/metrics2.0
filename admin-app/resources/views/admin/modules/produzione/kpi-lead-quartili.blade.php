<x-admin.wrapper :containerless="true">
    <x-slot name="title">{{ __('KPI Lead Quartili') }}</x-slot>
    
    <x-admin.page-header 
        title="KPI Lead Quartili" 
        subtitle="Analisi KPI per quartili"
        icon="chart-bar"
        iconColor="warning"
    >
        <x-slot name="actions">
    ...
    <x-admin.card tone="light" shadow="lg" padding="loose">
        <div class="text-center py-12">
            ...
            <h2 class="text-2xl font-bold text-base-content mb-4">KPI Lead Quartili</h2>
            <p class="text-base-content/70 text-lg mb-6">
                Questa vista è pronta per essere personalizzata con KPI quartili.
            </p>
