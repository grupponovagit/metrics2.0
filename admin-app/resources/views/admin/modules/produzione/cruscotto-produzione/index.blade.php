            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3 py-2">
                        <input type="checkbox" name="includi_bonus" value="1" class="checkbox checkbox-warning checkbox-md" {{ request('includi_bonus') ? 'checked' : '' }}>
                        <span class="label-text font-semibold text-base">
                            <x-ui.icon name="gift" class="h-5 w-5 inline text-warning" />
                            Includi Bonus e Incentivi
                        </span>
                    </label>
                    <p class="text-xs text-base-content/60 ml-10 mt-1">
                        Aggiungi i bonus e incentivi al fatturato e fatturato PAF
                    </p>
                </div>
